...
<cfoutput>
	<script type="text/javascript">
		function confirmDelete(path,item) {
			if(confirm("Are you sure you wish to delete item '" + item + "' ?\n\nThis action cannot be undone")) {
				document.location = "index.cfm?event=navMenu.ehGeneral.doDeleteItem&path="+path;
			}
		}
	</script>
	...
	<p style="font-size:13px;">
		<b>Path:</b>
		( <a href="index.cfm?event=navMenu.ehGeneral.dspMain">Top</a> )
		<cfloop from="1" to="#arrayLen(rs.aPathItems)#" index="i">
			<cfif i lt arrayLen(rs.aPathItems)>
				&raquo; <a href="index.cfm?event=navMenu.ehGeneral.dspMain&path=#rs.aPaths[i]#">#rs.aPathItems[i]#</a>
			<cfelse>
			...
			<td>
				<cfif rs.edit neq "">
					<form name="frm" method="post" action="index.cfm">
						<input type="hidden" name="event" value="navMenu.ehGeneral.doSaveItem">
						...
						<table class="browseTable" style="border:1px solid silver;background-color:##ebebeb;" cellpadding="3" cellspacing="0">
							...
							<tr>
								<td colspan="2">
									...
									&nbsp;&nbsp;
									<a href="index.cfm?event=navMenu.ehGeneral.dspMain&path=#rs.path#">Cancel</a>
								</td>
							</tr>
						</table>
					</form>
				...
				<cfelse>
					<div class="buttonImage btnLarge" style="margin:0px;">
						<a href="index.cfm?event=navMenu.ehGeneral.dspMain&path=#rs.path#&edit=#listAppend(rs.path,0)#"
				...
				<table class="browseTable" style="width:100%;">	
					...
					<cfloop from="1" to="#arrayLen(rs.xmlBase.xmlChildren)#" index="i">
						...
						<tr <cfif i mod 2>class="altRow"</cfif>>
							<td>#node.xmlAttributes.title#</td>
							...
							<td align="center">
								<a href="index.cfm?event=navMenu.ehGeneral.dspMain&edit=#thisPath#&path=#rs.path#"><img src="images/page_edit.png" alt="Edit item" border="0" align="absmiddle"></a>
								...
								<cfif i gt 1>
									<a href="index.cfm?event=navMenu.ehGeneral.doMoveUp&path=#thisPath#"><img src="images/arrow_up.png" alt="Move up" border="0" align="absmiddle"></a>
								</cfif>
								<cfif i lt arrayLen(rs.xmlBase.xmlChildren)>
									<a href="index.cfm?event=navMenu.ehGeneral.doMoveDown&path=#thisPath#"><img src="images/arrow_down.png" alt="Move down" border="0" align="absmiddle"></a>
								</cfif>
								<a href="index.cfm?event=navMenu.ehGeneral.dspMain&path=#thisPath#"><img src="images/chart_organisation.png" alt="View Sub-Items" border="0" align="absmiddle"></a>
							</td>
						</tr>
					</cfloop>
			...
			<td width="200">
				<div class="cp_sectionBox helpBox"  style="margin:0px;margin-left:10px;height:450px;line-height:18px;">
					<div style="margin:10px;">
						<h2>NavMenu</h2>
						This module allows you to define and manage a hierarchical structure to use as the navigation
						menu for your site.
					</div>
				</div>
			</td>
